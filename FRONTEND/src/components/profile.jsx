                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="w-full md:w-1/3 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm sticky top-24">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <h1 className="font-bold text-2xl text-gray-800 leading-tight">{user?.fullname}</h1>
                            ...
                            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-gray-700">
                                        <div className="p-2 bg-gray-50 rounded-lg"><Mail size={18} className="text-gray-400"/></div>
                                        <span className="text-sm font-semibold truncate">{user?.email}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-gray-700">
                                        <div className="p-2 bg-gray-50 rounded-lg"><Contact size={18} className="text-gray-400"/></div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {user?.profile?.skills?.length > 0 ? (
                                        user.profile.skills.map((item, index) => (
                                            <Badge key={index} className="bg-gray-800 text-white hover:bg-black px-3 py-1 text-[11px] font-medium border-none rounded-md">
                                                {item}
                                            </Badge>
                                        ))
                                    ) : (
                            ...
                            <div className="flex items-center justify-between bg-gray-50 p-4 rounded-xl border border-dashed border-gray-300">
                                <div className="flex items-center gap-4 overflow-hidden">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] text-gray-500 uppercase font-bold">Official Document</span>
                                    </div>
                                </div>
                                {isResume && (
                                    <a
