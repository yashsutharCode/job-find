...
const Profile = () => {
  ...
  // Updated to show the newly uploaded profilePhoto if available
  const profilePhoto =
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="w-full md:w-1/3 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm sticky top-24">
            <div className="flex flex-col items-center text-center">
              <Avatar className="h-28 w-28 border-4 border-purple-600 shadow-md mb-4 bg-gray-100 overflow-hidden">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-gray-700">
                    ...
                    <span className="text-sm font-semibold">
                      {/* Fixed: Consistent retrieval of phone number */}
